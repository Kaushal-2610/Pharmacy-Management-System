...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Role", "DOB (Date Of Birth)", "Email", "MobileNumber", "UserName", "Password", "Address"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 81, 826, 380));

        jLabel2.setText("Click On the row to delete User");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 470, -1, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString("id"),rs.getString("name"),rs.getString("userRole"),rs.getString("dob"),rs.getString("email"),rs.getString("mobilenumber"),rs.getString("username"),rs.getString("password"),rs.getString("address")});
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        else
        {
            ...
            if(a==0)
            {
                ...
                {
                    Connection con = ConnectionProvider.getcon();
                    PreparedStatement ps = con.prepareStatement("delete from appuser where id=?");
                    ps.setString(1,id);
                    ps.executeUpdate();
